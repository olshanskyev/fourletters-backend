...
public class MessageReadPayload {
  ...
  public MessageReadPayload event(@jakarta.annotation.Nonnull EventEnum event) {
  ...
  public MessageReadPayload data(@jakarta.annotation.Nonnull EventMessageReceipt data) {
