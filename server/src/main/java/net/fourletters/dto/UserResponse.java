 ...
 * Authentication endpoints for the fourletters messenger Hub.
 *
...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-06-05T11:41:46.358278400+03:00[Europe/Athens]", comments = "Generator version: 7.21.0")
public class UserResponse {
  ...
  public UserResponse id(@javax.annotation.Nonnull UUID id) {
  ...
  public UserResponse avatarUrl(@javax.annotation.Nullable URI avatarUrl) {
  ...
  public UserResponse roles(@javax.annotation.Nonnull List<String> roles) {
